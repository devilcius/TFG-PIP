...
En conjunto, los resultados previstos sostienen que la PIP no puede interpretarse únicamente como una conducta estereotipada ni como un efecto mecánico del reforzamiento por contigüidad. Más bien, su expresión parece modulada por variables emocionales y contextuales, en especial la privación social. Distinguir entre enriquecimiento sensorial y social permite abordar la paradoja de que ciertos objetos diseñados para promover el bienestar puedan, en determinadas condiciones, amplificar conductas compulsivas. Este trabajo contribuye así a perfilar la PIP como una forma de autorregulación frente a la imprevisibilidad del entorno, y a afinar los modelos animales que exploran la relación entre compulsividad y adaptación emocional.
